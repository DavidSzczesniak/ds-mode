...
Read the source-specific playbooks selected for the investigation. The playbooks are concrete examples for common MCPs; adapt them for a different tool in the same category.
