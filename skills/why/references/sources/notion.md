...
- **Doc vs. reality drift.** A spec may say "we'll do X" but the code actually does Y. Flag the divergence; the synthesis will surface the contradiction.
...
- Relevant linked pages (so the synthesis can cite them)
