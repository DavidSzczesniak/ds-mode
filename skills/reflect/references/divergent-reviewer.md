...
- `Read` tool calls against any `SKILL.md` file (repository `skills/`, project `.agents/skills/`, or user-level `~/.agents/skills/`)
- Codex worker briefs that name a skill path
