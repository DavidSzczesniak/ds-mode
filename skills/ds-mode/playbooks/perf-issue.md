...
3. Plan the fix from the trace. If it crosses a function boundary, run [**architect**](../../architect/SKILL.md) first. Delegate implementation to a fresh Implement worker; review the diff. Capture a post-fix trace.
