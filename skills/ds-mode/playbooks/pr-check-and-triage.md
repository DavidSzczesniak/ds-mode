...
This playbook performs no polling, sleeping, watcher, queue maintenance, merge, or landing action. Owner approval is a wait, not a blocker to fix. Merging routes to [Shipping](shipping.md) on a merge request.
