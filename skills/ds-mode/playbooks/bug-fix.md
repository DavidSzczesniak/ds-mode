...
3. Plan the fix. If it crosses a function boundary, run [**architect**](../../architect/SKILL.md) first. Delegate implementation to a fresh Implement worker with a specific scope; review the diff.
