...
**You own the resume point. Read the prior trail, don't redo it.** Use for a canonical Codex child target, resume note, result file, or pushed branch.
...
2. Read the metadata and last messages first, then scan back for decision points. Give a long transcript to a fresh native Codex Explore child and keep the reduced timeline in the lead context.
...
The decision trail records reasoning. A canonical child target identifies a conversation. Neither claims that a worker is still running.
