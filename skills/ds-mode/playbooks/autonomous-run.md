...
3. Each iteration makes the smallest change the evidence justifies, verifies it against the predicate, commits if repository instructions allow and the change advanced, and discards changes that did not help. Sequence the work via the **sequence-verifiable-units** principle skill.
...
5. Checkpoint every iteration via the **show-me-your-work** skill. Record what changed and whether the predicate moved.
