...
1. Identify the format and load it with the right tool. Parse large artifacts in a fresh Explore worker (the [**principle-guard-the-context-window**](../../principle-guard-the-context-window/SKILL.md) skill) and keep the reduced finding in the main thread.
