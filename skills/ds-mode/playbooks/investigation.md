...
1. Route through the [**how**](../../how/SKILL.md) skill (Explain mode for narrow questions, Critique mode for "are we sure?"). For motivation questions, also route through the [**why**](../../why/SKILL.md) skill.
...
No PR, no PR Check, no `architect` unless the investigation precedes a code change. If it does, hand back to the user and re-route to Bug fix or Feature.
