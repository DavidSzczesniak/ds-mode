...
| `principle-guard-the-context-window`                 | Context pressure is causing repeated reads, large outputs, or lost decisions. |
...
| `principle-never-block-on-the-human`                 | A reversible execution choice appears to require permission.                  |
...
| `principle-sequence-verifiable-units`                | A migration, sweep, or delivery sequence needs intermediate checks.           |
