...
1. Launch a fresh Review worker per `../ds-mode/references/workers.md`. Pass the scope and `references/comment-sicko.md` as its brief. Give it no edit permission.
