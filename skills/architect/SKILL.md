...
Use at least two fresh native Codex Judgment children. Follow the generic worker contract and keep candidate outputs isolated. These are same-family candidates under the current profiles.
