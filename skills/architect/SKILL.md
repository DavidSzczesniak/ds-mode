...
Use at least two named Pi Judgment workers. Follow the generic worker contract and keep candidate outputs isolated. These are same-family candidates under the current profiles.
