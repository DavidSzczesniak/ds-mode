...
2. **Critique.** Explain first, then launch fresh reviewers to identify architectural issues independently
...
- **Complex** (a subsystem spanning multiple files/services, a cross-cutting feature, a full architectural overview): launch fresh parallel Explore workers first, then hand off to the explainer. Go to Step 2a.
...
Launch all explorers as fresh workers. Follow `../ds-mode/references/workers.md`:
...
Launch one fresh worker that explores and explains in one pass:
...
Once all explorers return, launch one fresh Judgment worker to synthesize their findings into one coherent explanation:
...
After the explanation is complete, launch at least two fresh Review workers. Disclose the actual review composition per `../ds-mode/references/worker-profiles.md`.
