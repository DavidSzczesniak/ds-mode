...
6. For a big or wide change, run it as an [`arena`](../arena/SKILL.md). Ask workers on each configured model the same question and merge the answers. Different models catch different real bugs.
